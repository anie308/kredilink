...
function Tailored() {
  return (
    <div className="tailor-gradient p-[40px_20px]  flex flex-col items-center justify-center lg:p-[100px_40px] mt-[80px] text-white">
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-4 mt-[40px] gap-[20px] w-full lg:w-[85%]">
        <div className="w-full lg:w-[300px] overflow-hidden h-[300px]  rounded-[40px] relative">
