...
function Mission() {
    return (
        <div className="w-full flex items-center justify-center mt-[50px]">
            <div className="bg-white relative grid lg:grid-cols-2 gap-[40px] text-black p-[40px_20px] lg:p-[40px] rounded-[20px] w-full lg:*:w-[85%]">
                ...
                <img src="./pattrn.svg" className="absolute bottom-0" alt="" />
            </div>
