...
function Offers() {
    return (
        <div className=" flex items-center justify-center p-[40px_20px] lg:p-[100px_40px]">
            <div className="w-full lg:w-[65%] grid lg:grid-cols-2">

                <div className="flex items-center justify-end">
                    <div className="bg-[#0A183D] p-[20px] h-fit w-fit border-white rounded-t-[10px] lg:rounded-l-[8px]">
                ...
                <div className="bg-[#F2F7F6] p-[20px] flex flex-col items-start space-y-[15px]">
                    <div>
