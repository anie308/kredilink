...
function HomeHero() {
  return (
    <div className='hero-bg flex items-center flex-col justify-center p-[40px_10px] lg:p-[80px_40px] h-fit lg:h-[800px]'>
      ...
      <div className="mt-[150px] lg:mt-[150px] w-full lg:w-[55%] grid lg:grid-cols-3 gap-[20px] lg:gap-[20px]">
